...
namespace Feedback.API.Model.Log_API_Count
{
    public class APIRequestCount<T> : IActionFilter where T : class
    {
        private FeedbackContext _db;
        private IHttpContextAccessor _context;
        public APIRequestCount(FeedbackContext db, IHttpContextAccessor context)
        {
            _db = db;
            _context = context;
        }
        ...
        public void OnActionExecuting(ActionExecutingContext context)
        {
            ...
            try
            {
                ...
                clientUserApiCount.ServiceName = "Feedback";
