...
//using Evaluation.API.Repositories.Interfaces.EdCast;
using Evaluation.API.Models;
using System.Text;
//using static Courses.API.Models.CourseContext;
using static Evaluation.API.Common.EnumHelper;
using AzureStorageLibrary.Model;
using AzureStorageLibrary.Repositories.Interfaces;
using static Evaluation.API.Models.CourseContext;
...
namespace Evaluation.API.Repositories
{
    public class CourseRepository : Repository<Course>, ICourseRepository
    {
        ...
        public CourseRepository(CourseContext context, IAzureStorage azurestorage,  IConfiguration configuration, ICustomerConnectionStringRepository customerConnection, IIdentityService identitySv ,IHttpContextAccessor httpContextAccessor, IHostingEnvironment hostingEnvironment
            //, IEdCastTransactionDetails edCastTransactionDetails, IDarwinboxTransactionDetails darwinboxTransactionDetails, IDarwinboxConfiguration darwinboxConfiguration
            ) : base(context)
        {
            this._db = context;
        ...
        public void ChangeDbContext(string connectionString)
        {
            ...
            this._entities = this._context.Set<Course>();
        }
        ...
        //        //    APIPrerequisiteCourseStatus resultPrerequisiteStatus = await  (from Courses in this._db.Course
        //        //                                                            join c in this._db.Course on Courses.prerequisiteCourse equals c.Id
        ...
        //        //    try
        //        //    {
        //        //        if(resultPrerequisiteStatus != null)
        //        //        {
        //        //            string status = await (from Comp in _db.CourseCompletionStatus
        //        //                                   where (Comp.CourseId == resultPrerequisiteStatus.Id && Comp.UserId == UserId)
        //        //                                   select Comp.Status).FirstOrDefaultAsync();
        ...
        //        //    try
        //        //    {
        //        //        Courses.API.Model.Course course = await _db.Course.Where(a => a.Id == courseId).FirstOrDefaultAsync();
        //        //        if(course != null)
        //        //        {
