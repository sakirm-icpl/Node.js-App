...
namespace Evaluation.API.Repositories.Interfaces
{
    public interface IMyCoursesRepository
    {
        ...
        //Task<List<APICourseTypeahead>> SearchCourses( int userId ,string search = null);
        ...
        //Task<Message> EnrollCourseForTTgroup(int userId, int CourseId, string orgCode);
    }
}
