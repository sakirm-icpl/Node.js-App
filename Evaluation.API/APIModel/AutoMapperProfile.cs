...
using AutoMapper;
//using Courses.API.APIModel.ActivitiesManagement;
//using Courses.API.APIModel.AdministrativeFunctions;
//using Courses.API.APIModel.Competency;
//using Courses.API.APIModel.ILT;
//using Courses.API.APIModel.TrainersFunctions;
...
//using Evaluation.API.APIModel.NodalManagement;
