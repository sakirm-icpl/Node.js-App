...
using Evaluation.API.Model;
//using Evaluation.API.Model.ActivitiesManagement;
//using Evaluation.API.Model.AdministrativeFunctions;
//using Evaluation.API.Model.Competency;
//using Evaluation.API.Model.CourseRating;
//using Evaluation.API.Model.DiscussionForum;
//using Evaluation.API.Model.Feedback;
//using Evaluation.API.Model.ILT;
//using Evaluation.API.Model.MySupervisoryFunction;
//using Evaluation.API.Model.Process;
//using Evaluation.API.Model.TNA;
//using Evaluation.API.Model.TrainersFunctions;
...
using log4net;
//using Evaluation.API.Model.EdCastAPI;
//using Evaluation.API.Model.ThirdPartyIntegration;
//using Evaluation.API.Model.CourseDetail;
//using Evaluation.API.Model.Assessment;
...
namespace Evaluation.API.Models
{
    public class CourseContext : DbContext
    {
        ...
        //public DbSet<Model.Evaluation> Evaluation { get; set; }
       ...
       public DbSet<OERProcessResult> OERProcessResult { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //modelBuilder.Entity<Courses.API.Model.Course>().Property(x => x.RowGuid).HasDefaultValueSql("NEWID()");

            //modelBuilder.Entity<Courses.API.Model.AdministrativeFunctions.ModuleLevelPlanningDetail>()
            //   .HasOne(p => p.ModuleLevelPlannings)
            //   .WithMany(b => b.ModuleLevelPlanningDetails)
            //   .HasForeignKey(p => p.ModuleLevelPlanningId);

            //modelBuilder.Entity<Courses.API.Model.AdministrativeFunctions.BatchesFormationDetail>()
            //  .HasOne(p => p.BatchesFormations)
            //  .WithMany(b => b.BatchesFormationDetails)
            //  .HasForeignKey(p => p.BatchesFormationId);

            //modelBuilder.Entity<Courses.API.Model.AdministrativeFunctions.TrainingExpensesDetail>()
            // .HasOne(p => p.TrainingExpense)
            // .WithMany(b => b.TrainingExpensesDetails)
            // .HasForeignKey(p => p.TrainingExpenseId);

            //modelBuilder.Entity<Courses.API.Model.ActivitiesManagement.AssignmentsDetail>()
            // .HasOne(p => p.Assignment)
            // .WithMany(b => b.AssignmentsDetails)
            // .HasForeignKey(p => p.AssignmentId);

            //modelBuilder.Entity<Courses.API.Model.TrainersFunctions.TrainingAttendanceDetail>()
            //.HasOne(p => p.TrainingAttendances)
            //.WithMany(b => b.TrainingAttendanceDetails)
            //.HasForeignKey(p => p.TrainingAttendanceId);

            //modelBuilder.Entity<Courses.API.Model.TrainersFunctions.OfflineAssessmentScoresDetail>()
