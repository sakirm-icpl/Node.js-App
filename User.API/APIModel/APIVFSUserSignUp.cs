...
namespace User.API.APIModel
{
    public class APIVFSUserSignUp
    {
       ...
       [MaxLength(50)]
        [RegularExpression(@"\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*", ErrorMessage = "Invalid User Id")]
        [CSVInjection]
       ...
       public string Language { get; set; }
        ...
        public Exists ValidationsForUserSignUp(IUserSignUpRepository userRepository, APIVFSUserSignUp user)
        {
        ...
        public APIVFSUserSignUp MapUserSignupToAPIUser(APIVFSUserSignUp user)
        {
            APIVFSUserSignUp apiUser = new APIVFSUserSignUp();
            ...
            apiUser.Business = user.Business == null ? null : user.Business.Trim();
