...
using Competency.API.Middleware;
using Competency.API.Models;
using Competency.API.Repositories;
//using Competency.API.Repositories.ActivitiesManagement;
//using Courses.API.Repositories.AdministrativeFunctions;
using Competency.API.Repositories.Competency;
//using Competency.API.Repositories.CourseRating;
//using Competency.API.Repositories.DiscussionForum;
//using Competency.API.Repositories.ILT;
using Competency.API.Repositories.Interfaces;
//using Competency.API.Repositories.Interfaces.ActivitiesManagement;
//using Courses.API.Repositories.Interfaces.AdministrativeFunctions;
using Competency.API.Repositories.Interfaces.Competency;
//using Competency.API.Repositories.Interfaces.CourseRating;
//using Competency.API.Repositories.Interfaces.DiscussionForum;
//using Competency.API.Repositories.Interfaces.ILT;
//using Competency.API.Repositories.Interfaces.TNA;
//using Courses.API.Repositories.Interfaces.TrainersFunctions;
//using Courses.API.Repositories.TNA;
//using Courses.API.Repositories.TrainersFunctions;
...
//using Process.API.Repositories;
//using Process.API.Repositories.Interface;
using Swashbuckle.AspNetCore.Swagger;
using System;
using System.Text.Json;
using Microsoft.OpenApi.Models;
//using Courses.API.Repositories.Interfaces.ThirdPartyIntegration;
//using Courses.API.Repositories.ThirdPartyIntegration;
...
namespace Competency.API
{
    public class Startup
    {
        ...
        private void ConfigureAuthService(IServiceCollection services)
        {
            try
            {
                ...
                .AddOAuthIntrospection(options =>
                {
                    ...
                    options.Audiences.Add("competency_api");
                    options.ClientId = "competency_api";
                ...
                {
                    options.AddPolicy("AllowGoGetEmpoweredSubDomains",
              builder => builder
                           .SetIsOriginAllowedToAllowWildcardSubdomains()
                           .WithOrigins("https://*.gogetempowered.com")
                           .AllowAnyMethod()
                           .AllowCredentials()
                           .AllowAnyHeader()
                           .Build()
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseCors("AllowGoGetEmpoweredSubDomains");
