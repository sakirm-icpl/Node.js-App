...
//using Competency.API.Model.ActivitiesManagement;
...
namespace Competency.API.Models
{
    public class CourseContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Course>().Property(x => x.RowGuid).HasDefaultValueSql("NEWID()");
