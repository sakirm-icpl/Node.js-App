...
namespace Competency.API.Repositories.Competency
{
    public class CompetencyLevelsRepository : Repository<CompetencyLevels>, ICompetencyLevelsRepository
    {
        ...
        public CompetencyLevelsRepository(CourseContext context, IConfiguration configuration, ICustomerConnectionStringRepository customerConnectionStringRepository) : base(context)
        {
            this.db = context;
