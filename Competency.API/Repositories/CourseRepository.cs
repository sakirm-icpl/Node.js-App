...
using log4net;
//using Competency.API.APIModel.NodalManagement;
...
using System.Text;
using static Competency.API.Models.CourseContext;
using static Competency.API.Common.EnumHelper;
...
namespace Competency.API.Repositories
{
    public class CourseRepository : Repository<Model.Course>, ICourseRepository
    {
        ...
        {
            IQueryable<Model.Course> Query = _db.Course.Where(c => c.IsDeleted == false);
