...
using ILT.API.Repositories;
using ILT.API.Repositories.Interfaces;
using AutoMapper;
using ILT.API.APIModel;
using ILT.API.Helper;
using ILT.API.Middleware;
using ILT.API.Models;
//using ILT.API.Repositories;
//using ILT.API.Repositories.ActivitiesManagement;
//using ILT.API.Repositories.AdministrativeFunctions;
//using ILT.API.Repositories.Competency;
//using ILT.API.Repositories.CourseRating;
//using ILT.API.Repositories.DiscussionForum;
//using ILT.API.Repositories;
//using ILT.API.Repositories.Interfaces;
//using ILT.API.Repositories.Interfaces.ActivitiesManagement;
//using ILT.API.Repositories.Interfaces.AdministrativeFunctions;
//using ILT.API.Repositories.Interfaces.Competency;
//using ILT.API.Repositories.Interfaces.CourseRating;
//using ILT.API.Repositories.Interfaces.DiscussionForum;
//using ILT.API.Repositories.Interfaces.ILT;
//using ILT.API.Repositories.Interfaces.TNA;
//using ILT.API.Repositories.Interfaces.TrainersFunctions;
//using ILT.API.Repositories.TNA;
//using ILT.API.Repositories.TrainersFunctions;
...
//using ILT.API.Repositories.Interfaces.ThirdPartyIntegration;
//using ILT.API.Repositories.ThirdPartyIntegration;
        ...
        private void ConfigureAuthService(IServiceCollection services)
        {
            try
            {
                ...
                .AddOAuthIntrospection(options =>
                {
                    ...
                    options.Audiences.Add("ilt_api");
                    options.ClientId = "ilt_api";
