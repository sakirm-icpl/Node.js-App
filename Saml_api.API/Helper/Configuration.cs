namespace Saml.API.Helper
{
    public static class Configuration
    {
        ...
        public static string NotificationApi = "Notificationapi_url";
        ...
        public static string OtpValidityTime = "OtpValidityTime";
        public static string AuditApi = "AuditApi";
        public static string IdentityUrl = "IdentityUrl";
