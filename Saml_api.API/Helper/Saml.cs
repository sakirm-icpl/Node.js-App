...
namespace Saml
{
    ...
    public class Response
    {
        ...
        public bool IsValid()
        {
            ...
            XmlNode node = _xmlDoc.SelectSingleNode("/samlp:Response/samlp:Status/samlp:StatusCode", _xmlNameSpaceManager);

            var nodeValue = node.Attributes[0].InnerText;

            if (nodeList.Count == 0 && node == null) return false;
            ...
            if (nodeValue == "urn:oasis:names:tc:SAML:2.0:status:Success" && !IsExpired())
            {
                return true;
            }
        ...
        {
            XmlNode node = _xmlDoc.SelectSingleNode("/samlp:Response/saml:Assertion[1]/saml:AttributeStatement/saml:Attribute[@Name='Email']/saml:AttributeValue", _xmlNameSpaceManager);
            ...
            if (node == null)
                node = _xmlDoc.SelectSingleNode("/samlp:Response/saml:Assertion[1]/saml:AttributeStatement/saml:Attribute[@Name='User.Email']/saml:AttributeValue", _xmlNameSpaceManager);
        ...
        {
            XmlNode node = _xmlDoc.SelectSingleNode("/samlp:Response/saml:Assertion[1]/saml:AttributeStatement/saml:Attribute[@Name='FirstName']/saml:AttributeValue", _xmlNameSpaceManager);
        ...
        {
            XmlNode node = _xmlDoc.SelectSingleNode("/samlp:Response/saml:Assertion[1]/saml:AttributeStatement/saml:Attribute[@Name='LastName']/saml:AttributeValue", _xmlNameSpaceManager);
