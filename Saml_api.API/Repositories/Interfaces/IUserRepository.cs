...
namespace Saml  .API.Repositories.Interfaces
{
    public interface IUserRepository : IRepository<UserMaster>
    {
       ...
       // Task<UserMasterOtp> GetOTP(int UserID);
       // Task<int> AddUserMasterLogs(UserMasterLogs userMasterlogs);
       // Task<List<GetAllImagesPath>> GetAllImages();
       // Task<bool> IsExistsInConfig1(string userId);
       // Task<IEnumerable<ApiUserSearchV2>> SearchTrainer(string userId, string UserType = null);
