...
using MediaManagement.API.Repositories;
...
using MediaManagement.API.MiddleWare;
        ...
        private void ConfigureAuthService(IServiceCollection services)
        {
            try
            {
                ...
                .AddOAuthIntrospection(options =>
                {
                    ...
                    options.Audiences.Add("mediamanagement_api");
                    options.ClientId = "mediamanagement_api";
