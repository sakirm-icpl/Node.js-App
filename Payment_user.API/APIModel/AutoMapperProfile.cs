...
namespace Payment.API.APIModel
{
    public class AutoMapperProfile : Profile
    {
        public AutoMapperProfile()
        {
            ...
            //CreateMap<UserMaster, UserMasterDelete>()
            //    .ReverseMap();

            //CreateMap<UserMasterDetails, UserMasterDetailsDelete>()
            //   .ReverseMap();

            CreateMap<APIUserMaster, Signup>().ReverseMap();
            CreateMap<APIUserSignUp, UserMaster>()
                .ReverseMap();
