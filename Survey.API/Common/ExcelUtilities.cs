...
namespace Survey.API.Common
{
    public class ExcelUtilities
    {
        ...
        public FileInfo WriteDataTableToExcel(DataTable dataTable, string OrgCode, string fileName, string backupFileFolder)
        {
            FileInfo excelFileInfo = null;

            string sWebRootFolder = _configuration[Constants.AppSetting.ApiGatewayWwwRootFolderName];
            sWebRootFolder = Path.Combine(sWebRootFolder, OrgCode);
            string backUpFilePath = sWebRootFolder + @"\"+ backupFileFolder+@"\";
