...
//using MyCourse.API.Model.CourseRating;
using MyCourse.API.Model;
//using MyCourse.API.Model.Feedback;
//using MyCourse.API.Model.ILT;
//using MyCourse.API.Model.MySupervisoryFunction;
//using MyCourse.API.Model.Process;
//using MyCourse.API.Model.TNA;
//using MyCourse.API.Model.TrainersFunctions;
//ing Feedback.API.Model;
...
//using MyCourse.API.Model.ThirdPartyIntegration;
//using MyCourse.API.Model.CourseDetail;
...
namespace MyCourse.API.Model
{
    public class CourseContext : DbContext
    {
        ...
        public DbSet<MyCourse.API.Model.Course> Course { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //modelBuilder.Entity<MyCourse.API.Model>().Property(x => x.RowGuid).HasDefaultValueSql("NEWID()");
