...
using MyCourse.API.Middleware;
using MyCourse.API.Model;
using MyCourse.API.Repositories;
//using MyCourse.API.Repositories.ActivitiesManagement;
//using MyCourse.API.Repositories.AdministrativeFunctions;
//using MyCourse.API.Repositories.Competency;
using MyCourse.API.Repositories.CourseRating;
using MyCourse.API.Repositories.DiscussionForum;
//using MyCourse.API.Repositories.ILT;
using MyCourse.API.Repositories.Interfaces;
//using MyCourse.API.Repositories.Interfaces.ActivitiesManagement;
//using MyCourse.API.Repositories.Interfaces.AdministrativeFunctions;
//using MyCourse.API.Repositories.Interfaces.Competency;
...
//using MyCourse.API.Repositories.Interfaces.TNA;
//using MyCourse.API.Repositories.Interfaces.TrainersFunctions;
//using MyCourse.API.Repositories.TNA;
//using MyCourse.API.Repositories.TrainersFunctions;
...
//using MyCourse.API.Repositories.Interfaces.ThirdPartyIntegration;
//using MyCourse.API.Repositories.ThirdPartyIntegration;
using AspNetCoreRateLimit;
//using MyCourse.API.Repositories.EdCast;
        ...
        private void ConfigureAuthService(IServiceCollection services)
        {
            try
            {
                ...
                .AddOAuthIntrospection(options =>
                {
                    ...
                    options.Audiences.Add("mycourse_api");
                    options.ClientId = "mycourse_api";
