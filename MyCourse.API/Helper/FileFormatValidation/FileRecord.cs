...
namespace MyCourse.API.Helper.FileFormatValidation
{
    /// <summary>
    /// Present one record.
    /// </summary>
    public class FileRecord
    {
        ...
        public FileRecord(string extentions, string hex)
        {
        ...
        public FileRecord(string extentions, string hex, int offset)
        {
            Offset = offset;
            Extentions = extentions;
            Hex = hex;
        ...
        public FileRecord(string extentions, string hex, string description)
        {
            Extentions = extentions;
            Hex = hex;
        ...
        /// <param name="description">description</param>
        public FileRecord(string extentions, string hex, int offset, string description)
        {
            Offset = offset;
            Extentions = extentions;
            Hex = hex;
