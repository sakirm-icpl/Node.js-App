...
namespace MyCourse.API.Repositories
{
    public class CoursesEnrollRequestRepository : Repository<CoursesEnrollRequest>, ICoursesEnrollRequestRepository
    {
        ...
        public CoursesEnrollRequestRepository(CourseContext context) : base(context)
        {
            _db = context;
    ...
    {
        private CourseContext _db;
        public CoursesEnrollRequestDetailsRepository(CourseContext context) : base(context)
        {
            _db = context;
        }
    }
