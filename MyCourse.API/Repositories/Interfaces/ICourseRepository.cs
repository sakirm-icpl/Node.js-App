...
namespace MyCourse.API.Repositories{
    public interface ICourseRepository : IRepository<MyCourse.API.Model.Course>
    {
        ...
        //Task<int> AddCourseHistory(MyCourse.API.Model.Course oldCourse, MyCourse.API.Model.Course newCourse,
        ...
        //Task<int> UpdateCourseNotification(MyCourse.API.Model.Course oldCourse, int courseId, string title, string courseCode, string token);

        //Task<int> UpdateCourseNotification(MyCourse.API.Model.Course oldCourse, int courseId, string title, string token);
        ...
        Task<MyCourse.API.Model.Course> GetCourseInfoByCourseCode(string CourseCode);
     ...
     //   Task<MyCourse.API.Model.Course> GetCourseInfoByCourseName(string courseName);
