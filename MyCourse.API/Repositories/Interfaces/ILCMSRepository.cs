...
namespace MyCourse.API.Repositories.Interfaces
{
    public interface ILCMSRepository : IRepository<LCMS>
    {
        ...
        //Task<int> SaveVideo(IFormFile uploadedFile, LCMS lcms, int UserId, string ordCode);
        //Task<int> SaveAudio(IFormFile uploadedFile, LCMS lcms, int UserId, string ordCode);
        //Task<int> SavePdf(IFormFile uploadedFile, LCMS lcms, int UserId, string ordCode);
        //Task<int> SaveImage(IFormFile uploadedFile, LCMS lcms, int UserId, string ordCode);
