...
using System.Text;
//using MyCourse.API.APIModel.ThirdPartyIntegration;
...
namespace MyCourse.API.Repositories
{
    public class LCMSRepositrory : Repository<LCMS>, ILCMSRepository
    {
      ...
      // static string EnableBlobStorage =  _courseRepository.GetMasterConfigurableParameterValue("Enable_BlobStorage");
        ...
        //    return response;
        //}
        //public async Task<int> SaveVideo(IFormFile uploadedFile, LCMS lcms, int UserId, string ordCode)
        //{
        //    string filePath = string.Empty;
        //    string fileName = string.Empty;
        ...
        //        return -1;
        //    }
        //    LCMS lCMS = _db.LCMS.Where(a => a.Name == vimeoVideo.name).FirstOrDefault();
        //    if(lCMS != null)
        //    {
        //        return -1;
        //    }
        ...
        //    return vimeoLink;
        //}
        //public async Task<int> SaveAudio(IFormFile uploadedFile, LCMS lcms, int UserId, string ordCode)
        //{
        ...
        //    return 1;
        //}
        //public async Task<int> SavePdf(IFormFile uploadedFile, LCMS lcms, int UserId, string ordCode)
        //{
        ...
        //    return 1;
        //}
        //public async Task<int> SaveImage(IFormFile uploadedFile, LCMS lcms, int UserId, string ordCode)
        //{
        ...
        //                      ExternalContentProvider = lcms.ExternalContentProvider
        //                  });
        ...
        //            case "zobble":
        //                if (apiGetLCMSMedia.metaData == null)
        //                    result = result.Where(l => l.ExternalContentProvider.ToLower().StartsWith(apiGetLCMSMedia.search.ToLower()) && l.IsExternalContent == true) ;
        //                if (apiGetLCMSMedia.metaData != null)
        //                    result = result.Where(f => (f.MetaData.ToLower().Contains(apiGetLCMSMedia.metaData) || f.Name.ToLower().Contains(apiGetLCMSMedia.metaData.ToLower()))
        //                    && f.ExternalContentProvider.ToLower().StartsWith(apiGetLCMSMedia.search.ToLower()) && f.IsExternalContent == true
        //                    );
        //                break;
        //            default:
        //                if (apiGetLCMSMedia.metaData == null)
        ...
        //            case "zobble":
        //                if (apiGetLCMSMedia.metaData == null)
        //                    authorQuery = authorQuery.Where(l => l.ExternalContentProvider.ToLower().StartsWith(apiGetLCMSMedia.search.ToLower()) && l.IsExternalContent == true);
        //                if (apiGetLCMSMedia.metaData != null)
        //                    authorQuery = authorQuery.Where(f => (f.MetaData.ToLower().Contains(apiGetLCMSMedia.metaData) || f.Name.ToLower().Contains(apiGetLCMSMedia.metaData.ToLower()))
        //                    && f.ExternalContentProvider.ToLower().StartsWith(apiGetLCMSMedia.search.ToLower()) && f.IsExternalContent == true
        //                    );
        ...
        //    List<string> data = await _db.LCMS.Where(a => a.IsExternalContent == true).Select(a => a.ExternalContentProvider).Distinct().ToListAsync();
        //    return data;
        //}
