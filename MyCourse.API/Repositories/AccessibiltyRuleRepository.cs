...
//using static MyCourse.API.Models.CourseContext;
    ...
    public class AccessibiltyRuleRepository : Repository<AccessibilityRule>, IAccessibilityRule
    {
      ...
      //  private readonly IAccessibilityRuleRejectedRepository _accessibilityRuleRejectedRepository;
       ...
       // IEdCastTransactionDetails _edCastTransactionDetails;
        ...
        public AccessibiltyRuleRepository(CourseContext context, IConfiguration configuration, IHostingEnvironment hostingEnvironment /*IEdCastTransactionDetails edCastTransactionDetails, IAccessibilityRuleRejectedRepository accessibilityRuleRejectedRepository, ITLSHelper tlsHelper, INotification notification*/, ICustomerConnectionStringRepository customerConnectionRepository) : base(context)
        {
        ...
        //                    {
        //                        MyCourse.API.Model.Course course = _db.Course.Where(a => a.Id == accessibilityRules.CourseId).FirstOrDefault();
