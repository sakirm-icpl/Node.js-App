...
//using static MyCourse.API.APIModel.ILT.APIGoToMeeting;
...
namespace MyCourse.API.Repositories
{
    public class ILTScheduleRepository : Repository<ILTSchedule>, IILTSchedule
    {
       ...
       // IOnlineWebinarRepository _onlineWebinarRepository;
        ...
        //                            List<APIILTNominationEmail> objIltEmail = new List<APIILTNominationEmail>();
        //                            foreach (DataRow row in dt.Rows)
        //                            {
        ...
        //                                APIILTNominationEmail objschedule = new APIILTNominationEmail();
        ...
        //                                objschedule.CourseTitle = aPIILTSchedular.CourseName; 
        //                                objschedule.toEmail = Convert.ToString(row["EmailId"]);
        //                                objschedule.LearnerName = Convert.ToString(row["UserName"]);
        //                                objschedule.ScheduleCode = aPIILTSchedular.ScheduleCode;
        //                                objschedule.VenueAddress = aPIILTSchedular.postalAddress;
        //                                objschedule.StartDate = Convert.ToString(aPIILTSchedular.StartDate.Date.ToString("MMM dd, yyyy"));
        //                                objschedule.StartTime = aPIILTSchedular.StartTime;
        //                                objschedule.orgCode = OrganisationCode;
        //                                if (aPIILTSchedular.WebinarType != null)
        //                                {
        //                                    if (aPIILTSchedular.teamsScheduleDetails.Count() != 0)
        //                                    {
        //                                        objschedule.GoToMeetingUrl = aPIILTSchedular.teamsScheduleDetails.Select(a=>a.JoinUrl).FirstOrDefault();
        //                                    }
        //                                    else if   (aPIILTSchedular.googleMeetDetails != null)
        //                                    {
        //                                        objschedule.GoToMeetingUrl = aPIILTSchedular.googleMeetDetails.HangoutLink;
        //                                    }
        //                                    else if (aPIILTSchedular.zoomScheduleDetails != null)
        //                                    {
        //                                        objschedule.GoToMeetingUrl = aPIILTSchedular.zoomScheduleDetails.join_url;
        //                                    }
        //                                }

        //                                lstApiNotification.Add(Notification);
        //                                objIltEmail.Add(objschedule);

        //                                count++;
        //                                if (count % Constants.BATCH_SIZE == 0)
        //                                {
        //                                    await ScheduleRequestNotificationTo_CommonBulk(lstApiNotification, token);
        //                                    await this._email.SendTrainerMailForSchedule(objIltEmail);
        ...
        //                                MyCourse.API.Model.Course course = _db.Course.Where(a => a.Code == dataRow["CourseCode"].ToString()).FirstOrDefault();
