...
//using MyCourse.API.APIModel.TigerhallIntegration;
using MyCourse.API.ExternalIntegration.EdCast;
using Microsoft.AspNetCore.Hosting;
//using MyCourse.API.Repositories.Interfaces.EdCast;
//using MyCourse.API.Model.EdCastAPI;
using System.Text;
using static MyCourse.API.Model.CourseContext;
...
{
    public class CourseRepository : Repository<MyCourse.API.Model.Course>, ICourseRepository
    {
       ...
       // INotification _notification;
        ...
        public void ChangeDbContext(string connectionString)
        {
            ...
            this._entities = this._context.Set<MyCourse.API.Model.Course>();
        }
        ...
        //{
        //    IQueryable<MyCourse.API.Model.Course> Query = _db.Course.Where(c => c.IsDeleted == false);
        ...
        //    return id;
        //}
        //public async Task<int> UpdateCourseNotification(MyCourse.API.Model.Course oldCourse, int courseId, string title, string courseCode, string token)
        //{
        //    ApiNotification Notification = new ApiNotification();
        //    Notification.Title = title;
        //    Notification.Message = this._configuration[Configuration.CourseNotification].ToString();
        ...
        //{
        //    MyCourse.API.Model.Course Course = await this._db.Course.Where(c => c.Id == courseId && c.IsDeleted == Record.NotDeleted).FirstOrDefaultAsync();
        //    if (Course == null)
        ...
        //    List<MyCourse.API.Model.CourseModuleAssociation> CourseMOduleAssociation = this._db.CourseModuleAssociation.Where(cm => cm.CourseId == Course.Id).ToList();
        ...
        //}
        //public async Task<int> AddCourseHistory(MyCourse.API.Model.Course oldCourse, MyCourse.API.Model.Course newCourse,
        ...
        public async Task<MyCourse.API.Model.Course> GetCourseInfoByCourseCode(string CourseCode)
        {
            MyCourse.API.Model.Course courseInfo = _db.Course.Where(c => c.Code == CourseCode).FirstOrDefault();
            return courseInfo;
        }

        //public async Task<MyCourse.API.Model.Course> GetCourseInfoByCourseName(string courseName)
        //{
        //    MyCourse.API.Model.Course courseInfo = _db.Course.Where(c => c.Title == courseName).FirstOrDefault();
        //    return courseInfo;
        //}
        ...
        //    try
        //    {
        //        MyCourse.API.Model.Course course = await _db.Course.Where(a => a.Id == courseId).FirstOrDefaultAsync();
        //        if(course != null)
        //        {
