...
using Courses.API.Model.CourseRating;
using Courses.API.Model.DiscussionForum;
using Courses.API.Model.Feedback;
using Courses.API.Model.ILT;
using Courses.API.Model.MySupervisoryFunction;
using Courses.API.Model.Process;
...
using Courses.API.Model.CourseDetail;
using Courses.API.Model.Log_API_Count;
using Courses.API.Model.Assessment;
...
namespace Courses.API.Models
{
    public class CourseContext : DbContext
    {
        ...
        public DbSet<Courses.API.Model.Course> Course { get; set; }
