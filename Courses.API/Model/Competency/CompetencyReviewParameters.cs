...
namespace Courses.API.Model.Competency
{
    ...
    public class APICompetencyReviewparameterImport
    {
    ...
    public class APICompetencyReviewParameterImportColumns
    {
        public const string Category = "Category";
        public const string SubCategory = "Subcategory";
        public const string SubSubCategory = "SubSubcategory";
        public const string Competency = "CompetencyName";
        public const string Level = "CompetencyLevel";
        public const string Reviewparameter = "Reviewparameter";
