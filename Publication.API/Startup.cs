...
using Publication.API.Repositories;
...
using Publication.API.MiddleWare;
using Publication.API.MiddleWare;
        ...
        private void ConfigureAuthService(IServiceCollection services)
        {
            try
            {
                ...
                .AddOAuthIntrospection(options =>
                {
                    ...
                    options.Audiences.Add("publication_api");
                    options.ClientId = "publication_api";
