...
using static CourseApplicability.API.Models.CoursesApplicabilityContext;
...
namespace CourseApplicability.API.Repositories
{
    public class TokensRepository : Repository<Tokens>, ITokensRepository
    {
        ...
        public TokensRepository(CoursesApplicabilityContext context, ICustomerConnectionStringRepository customerConnectionString, IHttpContextAccessor httpContext) : base(context)
        {
            this._db = context;
