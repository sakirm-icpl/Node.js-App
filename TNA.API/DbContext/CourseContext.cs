...
//;using TNA.API.Model.CourseRating;
//using TNA.API.Model;
//using TNA.API.Model.ActivitiesManagement;
//using TNA.API.Model.AdministrativeFunctions;
//using TNA.API.Model.Competency;

//using TNA.API.Model.DiscussionForum;
//using TNA.API.Model.Feedback;
//using TNA.API.Model.CourseRating;
//using TNA.API.Model.MySupervisoryFunction;
//using TNA.API.Model.Process;
//using TNA.API.Model.TrainersFunctions;
using TNA.API.Model;
...
//using TNA.API.Model.ThirdPartyIntegration;
//using TNA.API.Model.CourseDetail;
using TNA.API.Model.Log_API_Count;
//using TNA.API.Model.Assessment;
...
namespace TNA.API.Model
{
    public class CourseContext : DbContext
    {
        ...
        public DbSet<TNA.API.Model.Course> Course { get; set; }
