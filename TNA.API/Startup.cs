...
using TNA.API.Repositories;
using TNA.API.Repositories.Interfaces;
using AutoMapper;
using TNA.API.Helper;
using TNA.API.Middleware;
//using Courses.API.Models;
//using TNA.API.Repositories;
//using Courses.API.Repositories.ActivitiesManagement;
//using Courses.API.Repositories.AdministrativeFunctions;
//using Courses.API.Repositories.Competency;
//using TNA.API.Repositories.CourseRating;
//using Courses.API.Repositories.DiscussionForum;
//using TNA.API.Repositories.ILT;
//using Courses.API.Repositories.Interfaces;
//using Courses.API.Repositories.Interfaces.ActivitiesManagement;
//using Courses.API.Repositories.Interfaces.AdministrativeFunctions;
//using Courses.API.Repositories.Interfaces.Competency;
//using Courses.API.Repositories.Interfaces.CourseRating;
//using Courses.API.Repositories.Interfaces.DiscussionForum;
...
//using TNA.API.Repositories.Interfaces.ThirdPartyIntegration;
//using TNA.API.Repositories.ThirdPartyIntegration;
using AspNetCoreRateLimit;
//using TNA.API.Repositories.EdCast;
        ...
        private void ConfigureAuthService(IServiceCollection services)
        {
            try
            {
                ...
                .AddOAuthIntrospection(options =>
                {
                    ...
                    options.Audiences.Add("tna_api");
                    options.ClientId = "tna_api";
