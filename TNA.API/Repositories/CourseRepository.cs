...
using log4net;
//using TNA.API.APIModel.NodalManagement;
//using CoTNAurses.API.APIModel.TigerhallIntegration;
using TNA.API.ExternalIntegration.EdCast;
using Microsoft.AspNetCore.Hosting;
//using TNA.API.Repositories.Interfaces.EdCast;
using TNA.API.Model.EdCastAPI;
using System.Text;
//using static TNA.API.Models.CourseContext;
using static TNA.API.Common.EnumHelper;
